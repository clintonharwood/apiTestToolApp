...
var authServer = {
	authorizationEndpoint: 'https://test.clintox.xyz/employees/s/employees/services/oauth2/authorize',
	tokenEndpoint: 'https://test.clintox.xyz/employees/s/employees/services/oauth2/token'
};
